...
public class DFAppDataSeederContributor
    : IDataSeedContributor, ITransientDependency
{

    private readonly IRepository<ConfigurationInfo, long> _configurationRepository;

    public DFAppDataSeederContributor(IRepository<ConfigurationInfo, long> configurationRepository)
    {
