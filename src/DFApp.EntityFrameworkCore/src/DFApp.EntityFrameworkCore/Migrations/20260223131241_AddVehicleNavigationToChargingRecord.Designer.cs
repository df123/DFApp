...
namespace DFApp.src.DFApp.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260223131241_AddVehicleNavigationToChargingRecord")]
    partial class AddVehicleNavigationToChargingRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DFApp.Aria2.Response.TellStatus.FilesItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppAria2FilesItem", (string)null);
                });

            modelBuilder.Entity("DFApp.Aria2.Response.TellStatus.TellStatusResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("Bitfield")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long?>("UploadSpeed")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.ToTable("AppAria2TellStatusResult", (string)null);
                });

            modelBuilder.Entity("DFApp.Aria2.Response.TellStatus.UrisItem", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("FilesItemId");

                    b.ToTable("AppAria2UrisItem", (string)null);
                });
            ...
            modelBuilder.Entity("DFApp.Configuration.ConfigurationInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ModuleName", "ConfigurationName")
                        .IsUnique();

                    b.ToTable("AppConfigurationInfo", (string)null);
                });
            ...
            modelBuilder.Entity("DFApp.ElectricVehicle.GasolinePrice", b =>
                {
                    ...
                    b.HasIndex("Province", "Date");

                    b.ToTable("AppGasolinePrice", (string)null);
                });

            modelBuilder.Entity("DFApp.FileFilter.KeywordFilterRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppKeywordFilterRule", (string)null);
                });

            modelBuilder.Entity("DFApp.FileUploadDownload.FileUploadInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppFileUploadInfo", (string)null);
                });
            ...
            modelBuilder.Entity("DFApp.Lottery.LotteryInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DFApp.Lottery.LotterySimulation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TermNumber", "GroupId");

                    b.ToTable("AppLotterySimulation", (string)null);
                });

            modelBuilder.Entity("DFApp.Media.MediaExternalLink", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppMediaExternalLink", (string)null);
                });

            modelBuilder.Entity("DFApp.Media.MediaExternalLinkMediaIds", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<long>("MediaExternalLinkId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("MediaExternalLinkId");

                    b.ToTable("AppMediaExternalLinkMediaIds", (string)null);
                });

            modelBuilder.Entity("DFApp.Media.MediaInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("DownloadTimeMs")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsDownloadCompleted")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppMediaInfo", (string)null);
                });

            modelBuilder.Entity("DFApp.Rss.RssMirrorItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppRssMirrorItem", (string)null);
                });

            modelBuilder.Entity("DFApp.Rss.RssSource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppRssSource", (string)null);
                });

            modelBuilder.Entity("DFApp.Rss.RssWordSegment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("RssMirrorItemId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RssMirrorItemId");

                    b.HasIndex("Word");

                    b.ToTable("AppRssWordSegment", (string)null);
                });
            ...
            modelBuilder.Entity("DFApp.Aria2.Response.TellStatus.FilesItem", b =>
                {
                    b.HasOne("DFApp.Aria2.Response.TellStatus.TellStatusResult", "Result")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("DFApp.Aria2.Response.TellStatus.UrisItem", b =>
                {
                    b.HasOne("DFApp.Aria2.Response.TellStatus.FilesItem", "FilesItem")
                        .WithMany("Uris")
                        .HasForeignKey("FilesItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FilesItem");
                });
            ...
            modelBuilder.Entity("DFApp.Media.MediaExternalLinkMediaIds", b =>
                {
                    b.HasOne("DFApp.Media.MediaExternalLink", "ExternalLink")
                        .WithMany("MediaIds")
                        .HasForeignKey("MediaExternalLinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
