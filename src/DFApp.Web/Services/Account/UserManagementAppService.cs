...
public class UserManagementAppService : AppServiceBase
{
    ...
    {
        await CheckPermissionAsync("UserManagement.Default");
    ...
    {
        await CheckPermissionAsync("UserManagement.Create");
    ...
    {
        await CheckPermissionAsync("UserManagement.Update");
    ...
    {
        await CheckPermissionAsync("UserManagement.Delete");
    ...
    {
        await CheckPermissionAsync("UserManagement.ChangePassword");
